...
1. Problems I ran into
    ...
    - Put figures and tables side by side. I figured out that the output must be HTML in order to realize this goal. However, after pushing RMD file, it looks messy. So please refer to my HTML file when reviewing it.
