...
From the figure, we can get the conclusion that people in Africa has shorter life expectancy than other continents. This can also be verified from the figure in the previous question.f The life expectancy in Asia is increasing since the number of country below average is getting fewer.
